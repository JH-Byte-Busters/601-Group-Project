import os, sys
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '..'))) # Set file path to root folder.
from PyQt5.QtWidgets import QPushButton, QGroupBox, QDialog, QVBoxLayout, QGridLayout, QApplication
from game_logic.player import GamePlayer
...
class GameBoard(QDialog):
    def __init__(self):
        ...
        # UI config vars:
        self.windows = []
        self.title = 'TRIVIAL COMPUTE GAME'
        self.left = 500
        self.top = 500
        self.width = 500
        self.height = 500
    ...
    def createGridLayout(self):
        ...
        self.cell23.clicked.connect(self.player.blue_category_clicked)
        layout.addWidget(self.cell23,2,4)
        self.player.cells.append(self.cell23)
        ...
        self.cell59.clicked.connect(self.player.red_category_clicked)
        layout.addWidget(self.cell59,6,4)
        self.player.cells.append(self.cell59)
        ...
        self.down.clicked.connect(self.player.move_down)
        ...
        self.right.clicked.connect(self.player.move_right)
